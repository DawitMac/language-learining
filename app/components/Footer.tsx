...
const Footer = () => {
  return (
    <div className='flex md:flex-row flex-col md:items-start items-center justify-center md:justify-evenly bg-[#EFEFEF] mb-12 py-10 md:gap-0 gap-6'>
        <div className='flex flex-col items-start justify-start md:w-[30%] w-[80%] gap-8'>
        ...
        <div className='flex flex-col items-start justify-start w-[80%] md:w-auto'>
        ...
        <div className='relative flex flex-col items-start justify-start w-[80%] md:w-auto'>
